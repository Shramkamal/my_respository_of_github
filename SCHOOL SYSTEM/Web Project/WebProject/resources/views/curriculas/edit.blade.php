...
@section('admin-content')
    ...
    <div class="card-content bg-white">
        <div class="overflow-x-auto pt-2">
            <form action="{{ route('curriculas.update', $curriculas->id) }}" method="POST"
                ...
                <div class="grid md:grid-cols-4 md:gap-6">
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="curricula_name" id="curricula_name"
                            ...
                            value="{{ old('curricula_name', $curriculas->name) }}" placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="curricula_level_of_education"
                            id="curricula_level_of_education"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('curricula_level_of_education', $curriculas->level_of_education) }}"
                            placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group">
                        ...
                        @if ($curriculas->curriculum_upload)
                            <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                Current File: {{ basename($curriculas->curriculum_upload) }}
                            </div>
                        @endif
                    </div>
