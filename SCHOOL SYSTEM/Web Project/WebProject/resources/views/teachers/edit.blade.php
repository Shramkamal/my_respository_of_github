                ...
                <div class="grid md:grid-cols-4 md:gap-6">
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="teacher_name" id="teacher_name"
                            ...
                            value="{{ old('teacher_name', $teacher->TeacherName) }}" placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group">
                        <input type="tel" name="teacher_MobileNumber" id="teacher_MobileNumber"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('teacher_MobileNumber', $teacher->MobileNumber) }}" placeholder="" />
                    ...
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="teacher_securityCode" id="teacher_securityCode"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('teacher_securityCode', $teacher->SecurityCode) }}" placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="teacher_nationalCardNumber" id="teacher_nationalCardNumber"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('teacher_nationalCardNumber', $teacher->NationalCardNumber) }}" placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group">
                        <select name="teacher_bloodGroup" id="teacher_bloodGroup"
                            ...
                            @foreach (['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'] as $bloodGroup)
                                <option value="{{ $bloodGroup }}" @if (old('teacher_bloodGroup', $teacher->BloodGroup) == $bloodGroup) selected @endif>
                    ...
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="teacher_LevelOfEducation" id="teacher_LevelOfEducation"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('teacher_LevelOfEducation', $teacher->LevelOfEducation) }}" placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group">
                        ...
                        <input type="date" name="teacher_InstallationDate" id="teacher_InstallationDate"
                               ...
                               value="{{ old('teacher_InstallationDate', optional($teacher->InstallationDate)->format('Y-m-d')) }}"
                    ...
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="teacher_StudyMaterials" id="teacher_StudyMaterials"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('teacher_StudyMaterials', $teacher->StudyMaterials) }}" placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="teacher_Assessment" id="teacher_Assessment"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('teacher_Assessment', $teacher->TeachersAssessment) }}" placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="teacher_HonoraryAward" id="teacher_HonoraryAward"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('teacher_HonoraryAward', $teacher->HonoraryAward) }}" placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="number" name="Teacher_Activity" id="Teacher_Activity"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('Teacher_Activity', $teacher->TeacherActivity) }}" placeholder=" " />
                        ...
                        <select name="curriculas_id" id="curriculas_id"
                            ...
                            @foreach ($curriculas as $curricula)
                                <option value="{{ $curricula->id }}"
                                    {{ (old('curriculas_id') == $curricula->id || $teacher->curriculas_id == $curricula->id) ? 'selected' : '' }}>
                                    {{ $curricula->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="relative z-0 w-auto mb-5 group ">
                        <input type="text" name="teacher_Certificate" id="teacher_Certificate"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('teacher_Certificate', $teacher->Certificate) }}" placeholder=" " />
                    ...
                    <div class="relative z-0 w-auto mb-5 group">
                        <textarea name="teacher_note" id="teacher_note"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            value="{{ old('teacher_note', $teacher->Note) }}" placeholder=" " /></textarea>
